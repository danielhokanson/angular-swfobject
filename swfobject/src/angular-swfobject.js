...
ua = (function () {
    ...
    if (typeof nav.plugins !== UNDEF && typeof nav.plugins[SHOCKWAVE_FLASH] === OBJECT) {
        ...
        try {
            var a;
            /*jshint ignore:start*/
            a = new ActiveXObject(SHOCKWAVE_FLASH_AX);//ActiveXObject is not recognized by jshint
            /*jshint ignore:end*/
        ...
        if (ua.ie && ua.win) {
            doc.attachEvent(ON_READY_STATE_CHANGE, function () {
                if (doc.readyState === 'complete') {
                    doc.detachEvent(ON_READY_STATE_CHANGE, onDomLoad);
                    callDomLoadFunctions();
                }
            });
        ...
        if (ua.wk) {
            (function () {
                ...
                if (!/loaded|complete/.test(doc.readyState)) {
                    $timeout(onDomLoad, 0); // jshint ignore:line
                    return;
                }
                callDomLoadFunctions();
            })();
            ...
            if (ua.ie && ua.win && obj.readyState !== 4) {
                ...
                (function () {
                    if (obj.readyState === 4) {
                        ...
                        $timeout(showExpressInstall, 10);// jshint ignore:line
                    }
                })();
            }
        ...
        if (ua.win && ua.ie) {
            ...
            if (nestedObj) {
                ...
                if (c) {
                    var cl = c.length;
                    for (var i = 0; i < cl; i++) {
                        if (!((c[i].nodeType === 1 || c[i].nodeType === 8) &&
                                c[i].nodeName === 'PARAM')) {
    ...
    var cleanup = (function () {
        if (ua.ie && ua.win) {
            $window.attachEvent('onunload', function () {
                ...
                swfobject = null;// jshint ignore:line
            });
        }
    })();
